...
import (
	...
	gst "github.com/sampleref/gortpgst/internal/gstreamer-sink"
	io "github.com/sampleref/gortpgst/internal/signalio"
)
...
func gstreamerReceiveMain() {
	...
	io.Decode(io.MustReadStdin(), &offer)
	...
	fmt.Println(io.Encode(*peerConnection.LocalDescription()))
